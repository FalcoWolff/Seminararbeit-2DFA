...
late 1950s. Early presentations of the result are commonly attributed to work
discussed at the Summer Institute of Symbolic Logic in 1957 and were later
referenced by Rabin and Scott in their seminal paper
\cite{rabin_scott_1959_finite_automata}. A complete published proof was given by
Shepherdson in the same year \cite{shepherdson_1959_reduction}, based on the
technique of \emph{crossing sequences}. 
A different and more elementary proof using a subset construction was later
